    ...
    Try {
        ...
        function Deploy ($createSite) {
            ...
            Try {
                ...
                Try {
                    Write-Log "Applying Page changes"
                    Invoke-PnPSiteTemplate -path $Script:TemplatePath -Handlers Pages -Parameters @{"licenseListID" = $licenseListId; "site" = $SolutionsSiteUrl } -WarningAction Ignore											  
                }
                ...
                Try {
                    Write-Log "Applying Site Security changes"
                    Invoke-PnPSiteTemplate -path $Script:TemplatePath -Handlers SiteSecurity -WarningAction Ignore
                }
                Catch {
                    Write-Log "Ran into an error applying Site Security changes, continuing"
                    #Sink all errors for this call, if the Group site was set to Private there's nothing we can do here.
                }
                ...
                Catch {
                    #No issue if we can't upload the logo. If this is a Group site we can't do this anyway.
                }
